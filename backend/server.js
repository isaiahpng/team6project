...
//         return res
//           .status(500)
//           .json({ message: "Error adding new inventory item" });
//       }
...
//       const sql =
//         "UPDATE inventory SET InventoryQuantity = InventoryQuantity - 1 WHERE ProductID = ?";
//       db.query(sql, [item.ProductID], (err, result) => {
//         if (err) {
//           console.error(
//             `Error updating inventory for ProductID ${item.ProductID}:`,
//             err.stack
//           );
//           return reject(err);
//         }
...
//       return res
//         .status(500)
//         .json({ message: "Error fetching last ShoppingCartID" });
//     }
...
//   const { UserID, OrderStatus, OrderDate, ShoppingCartID, CartItems } =
//     req.body;
